...
## R-111 — Manager office records

Diane allows supervised access. Visitor log shows Elena at **18:40**.

**Decision:**

| Action | Go to |
|---|---|
| Pull maintenance invoice binder | R-111a |
| Copy visitor log and key sign-out sheet | R-111b |

---

### R-111a — Invoice binder (destination)
...
## R-113 — Bakery camera still

Still image from hallway camera: Elena entered front door **18:41** — consistent with manager log.
...
## R-211 — Basement storage search

**If clock ≥ 22:00 without ACCESS_MANAGER_KEY:** spend **+10 min** to get key from J-302 first.

Storage latch is **bent**. Mop bucket sits **two meters** from the stair door — not where the floor plan marks the cleaning station.

**Record C-02** and **C-04**.

**Decision:**

| Action | Go to |
|---|---|
| Cast the boot impression near the landing door | R-211a |
| Photograph invoice box Elena pulled | R-211b |

---

### R-211a — Boot cast (destination)
...
| Action | Go to |
|---|---|
| Compare duplicate vendor payments | R-212a |
| Skim and move on | R-212b |

---

### R-212a — Duplicate payments (destination)
...
## R-213 — Elena draft email

On manager PC archive (supervised): draft from Elena at **14:00** citing maintenance fund discrepancies.
